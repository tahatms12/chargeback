...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  const assignedOrderIds = new Set(orderStages.map((os: OrderStageRecord) => os.orderId));
...
export default function QueueDashboard() {
  ...
  useEffect(() => {
    if (fetcher.data && typeof fetcher.data === "object" && "confirmationUrl" in fetcher.data) {
              ...
              <BlockStack gap="200">
                <InlineStack align="space-between">
                  ...
                  <Badge tone="attention">
                    {String((unassignedOrders as ShopifyOrder[]).length)} new
                  </Badge>
                </InlineStack>
              ...
              <Card>
                <BlockStack gap="200">
                  <InlineStack align="space-between">
                    ...
                    <Badge>
                      {String(orders.length)} order{orders.length !== 1 ? "s" : ""}
                    </Badge>
                  </InlineStack>
                </BlockStack>
                <Divider />
